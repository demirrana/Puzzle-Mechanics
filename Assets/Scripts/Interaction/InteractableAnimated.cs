...
public class InteractableAnimated : Interactable<IInteractableBehaviour>
{
    ...
    override protected void GetInteracted_Interactable<IInteractableBehaviour>(object sender, IInteractableBehaviour e)
    {
